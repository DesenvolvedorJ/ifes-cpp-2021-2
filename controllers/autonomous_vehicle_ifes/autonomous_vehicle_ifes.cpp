  ...
  while (simulador.run()) {
    ...
    if (simulador.refresh(i)) {
      ...
      if (simulador.autodriveEnabled()) {
        ...
        simulador.aceleracao(-6.2,104.5,75);
        simulador.aceleracao(103.7,74.7,68);
        simulador.aceleracao(104.0,36,82);
        simulador.aceleracao(102.4,-21.4,76);
        simulador.aceleracao(72.8,-44.4,120);
